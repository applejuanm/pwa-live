...
class PelisEditView  extends connect(store)(PageViewElement) {
  ...
  //si ha pasado de estado active o bien ha cambiado el parametro de edicion, enconces hago la busqueda
  //del componente en si
  updated(changedProperties) {
    if(changedProperties.has('editId') || changedProperties.has('active')) {
      //cada vez que me cambie el identificador de la pelicula lo reseteo
